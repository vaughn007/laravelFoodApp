        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h3><span class="section-subtitle about__initial" >Edit My Profile</span></h3>
                        <form autocomplete="off" action="/user/{{$user->id}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-2">
                                ...
                                <a class="btn btn-outline-danger float-right" style="color: red !important; background-color:#fff; !important" href="/delete-images/user/{{$user->id}}">Delete Image</a>
                            </div>
                            @endif
                            <div class="form-group">
                            ...
                            <input class="auth" type="submit" value="Update Profile">
                        </form>
                        {{-- <a class="btn btn-primary float-right" href="/home"><i class="fas fa-arrow-circle-up"></i> Back</a> --}}
                        <a class="buttonG float-right" href="/home"><i class="fas fa-arrow-circle-up"></i> Back</a>
                    </div>
                </div>
            </div>
        </div>
